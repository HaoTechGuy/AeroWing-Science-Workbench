...
To change the local backend without restoring the manual settings page, edit:
...
in `deepagent-ui.config.json`.

**Usage**

You can interact with the deployment via the chat interface.
...
You can optionally override the config file with environment variables:

```env
NEXT_PUBLIC_LANGGRAPH_DEPLOYMENT_URL="http://127.0.0.1:2024"
