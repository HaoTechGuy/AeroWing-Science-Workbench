...
export function officePreviewToMarkdown({
  ...
  const lines = [
    ...
    "",
    `Source file: ${sourceWorkspacePath}`,
...
function officePreviewKindForPath(filePath: string): WorkspaceOfficePreviewKind {
...
function getWorkbookSheets(
  ...
  if (workbookXml) {
    ...
    while ((sheetMatch = sheetRegex.exec(workbookXml))) {
      ...
      const sheetId = Number(getXmlAttribute(attrs, "sheetId")) || fallbackIndex;
